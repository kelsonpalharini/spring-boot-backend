...
import com.palharini.springupdate.domain.Estado;
...
import com.palharini.springupdate.domain.PagamentoComCartao;
...
import com.palharini.springupdate.domain.enums.Perfil;
...
import com.palharini.springupdate.repositories.CidadeRepository;
...
import com.palharini.springupdate.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p9 = new Produto(null, "Abajour", 300.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "palharinik@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "palharini23@gmail.com", "3162832740", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli2.addPefil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("54645632", "34534637"));
